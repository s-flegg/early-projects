...
class Animation(pygame.sprite.Sprite):
    ...
    def __init__(self, surface, centre_pos, file, file_type, frames, frame_mult, tpn_col):
        """
    ...
    def list_images(self):
        ...
        for i in range(self.frames):
            for j in range(self.frame_mult):
                ...
                image.set_colorkey(self.tpn_col, RLEACCEL)  # removes tpn_col and optimises
...
class Text(pygame.sprite.Sprite):
    ...
    def __init__(self, surface, centre_pos, font, text_rgb, bg_rgb, pre_var_text, post_var_text, var_func):
        """
        :type surface:
...
class ButtonBackground(Text):
    ...
    def __init__(self, surface, centre_pos, font, text_rgb, bg_rgb_def, bg_rgb_hover,
                 pre_var_text, post_var_text, var_func, action):
        """
        :type action: object
        ...
        """
        super().__init__(surface, centre_pos, font, text_rgb, bg_rgb_def, pre_var_text, post_var_text, var_func)
...
class ButtonEnlarge(ButtonBackground):
    ...
    def __init__(self, surface, centre_pos, text_name, text_size, text_bold, text_scale, text_rgb, bg_rgb,
                 pre_var_text, post_var_text,var_func, action):
        """
        ...
        self.font_enlarge = pygame.freetype.SysFont(text_name, text_size * text_scale, text_bold)
        super().__init__(surface, centre_pos, self.font_def, text_rgb, bg_rgb, bg_rgb, pre_var_text,
                         post_var_text, var_func, action)
...
class File:
    ...
    def get_file_as_sorted_list(self, reverse=False):
